...
public class CityListServiceTest {
	...
	public void getCityListTest() {
		City city = new City(1, "Tallin", "www.tallin.vom");
	...
	public void getCityListBYNameTest() {
		...
		List<CityResponse> result = service.getCityByName("Tallin");
		assertEquals(11L, result.get(0).getId());
		assertEquals("Tallin", result.get(0).getName());
	}

	@Test
	public void getByPageAndSizeTest() {
		City city = new City(11, "Hathras", "www.hts.vom");
		Mockito.when(repository.findAll(any(PageRequest.class))).thenReturn(new PageImpl<>(List.of(city)));
